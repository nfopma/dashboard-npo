INSERT INTO public.patients (
    ...
    gen_random_uuid(), -- Genereert een nieuwe UUID voor de patiënt ID
    NULL,              -- user_id is NULL voor de algemene testpatiënt
    'Jan Jansen',
    '{
      "basisgegevens": {
        "naam": "Jan Jansen",
      ...
      "voorinformatie": {
        "opleidingsniveau": "Je hebt praktijkonderwijs gevolgd.",
