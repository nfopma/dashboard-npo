...
import { ChevronLeft, ChevronRight, Save, Eye, Edit, HelpCircle } from 'lucide-react';
...
const BehandelaarInvoer = () => {
  // Gebruik de custom hook om formulier state en handlers te beheren
  const {
    formData,
    klachten,
  ...
  // State voor actieve sectie en preview modus
